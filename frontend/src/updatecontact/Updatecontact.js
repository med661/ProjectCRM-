...
const Updatecontact = () => {
  ...
  const getContact = () => {
    axiosIntance
      .get(`contact/getContact/${id}`, { headers: { Authorization: token } })
      .then((res) => {
  ...
  const fetchuser = async () => {
    await axios
      .get("user/profil", { headers: { Authorization: token } })
      .then(async (res) => {
  ...
  const handledUpddate = async (e) => {
    ...
    await axiosIntance
      .put(
        ...
        { name: name, mobile: mobile, adress: adress, email: email },
        data
      )
      .then((res) => {
      ...
      .catch((err) => {
        //console.log("problem");
        Swal.fire("contact added failure", "something went wrong", "error");
      });
  };
            ...
            <div className="content-wrapper">
              ...
              <div className="container-xxl flex-grow-1 container-p-y">
                <h4 className="fw-bold py-3 mb-4">
                  <span className="text-muted fw-light"></span> Update contact
                </h4>
                  ...
                  <div className="col-xxl">
                    <div className="card mb-4">
                      <div className="card-header d-flex align-items-center justify-content-between">
                        <h5 className="mb-0">Update profil contact</h5>
